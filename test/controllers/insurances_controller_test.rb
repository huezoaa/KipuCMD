...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { company: @insurance.company, group_id: @insurance.group_id, payment_method: @insurance.payment_method, policy_no: @insurance.policy_no }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { company: @insurance.company, group_id: @insurance.group_id, payment_method: @insurance.payment_method, policy_no: @insurance.policy_no }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
